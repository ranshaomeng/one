...
class hackTickets(object):
    ...
    def readConfig(self, config_file='config.ini'):
        ...
        try:
            ...
            cp.readfp(codecs.open('config.ini','r',encoding='UTF-8-MS'))
        except IOError as e:
        ...
        #抢到票后的邮件提醒 
        self.mail_user = cp.get("mail","mail_user")
        self.mail_pwd = cp.get("mail","mail_pwd")
        self.receiver = cp.get("mail","receiver")
